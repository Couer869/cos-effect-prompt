...
| 模块 | 能力 | 触发词示例 |
|---|---|---|
| `special_effects` | 特效：**44 种**（魔法阵 / 火焰 / 雷电 / 机械装甲 / 藤蔓 / 全息 / 凤凰…）+ **特效组合模板**，默认 CG 质感 / 建模画风 | "加魔法阵" "手上加火焰" "组合特效" |
| `face_retouch` | 修脸：磨皮 / 祛瑕疵 / 瘦脸 / 眼神光 / 妆容 / 发际线（默认自然档） | "修脸自然点" "祛痘印" "瘦下巴" |
| `hair_enhancement` | 头发：丝绸光泽 + 闪粉星尘 + **CG写实毛发**（XGen）/ **赛璐璐手绘** / **刘海修整** / **长发飘动** | "头发亮晶晶" "CG毛发" "刘海修整" |
| `clothing_refresh` | 服装：面料焕新 / 褶皱管理 / 瑕疵修复 / **材质细化**（缎面/皮革/蕾丝/金属）/ **C服还原** / **绷紧** / **勒肉** | "衣服太皱了" "去污渍" "绷紧衣服" |
| `body_sculpting` | 塑形：液化瘦腰 + **沙漏比例** / 胸部 / 腰部 / 腹肌 / 肩颈 / **体毛移除** + 背景修复 | "瘦腰" "腹肌" "体毛移除" |
